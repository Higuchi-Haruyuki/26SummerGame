...
void PlayerUI::InitInventoryItemPanel()
{
	...
	const auto& inventoryClose = UIFactory::MakeUIToPanel<UIKeyPrompt>(m_inventoryUIPanel, kKeyPromptDownLeftPos + Vector{ -1000 }, kKeyPromptSize, GraphicId::kKeyboardTab, "閉じる");
